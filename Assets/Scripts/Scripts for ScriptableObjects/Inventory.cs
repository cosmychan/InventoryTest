...
{
    //public List<InventorySlot> inventoryItems = new List<InventorySlot>(); //the list of items
    ...
    //    if (!_hasItem)
    //    {
    //        inventoryItems.Add(new InventorySlot(_item, _amount)); //if there is no duplicate, we add the item to the list
    //    }
    //}
}
